...
public static class SystemPromptConstants
{
    private const string ProcessXliffFile =
        "You will receive a text to process based on the following instructions: {instructions}. " +
        ...
        "Please process text accordingly and provide only the target text in the response. " +
    ...
    private const string PostEditXliffFile =
        "You will receive a text that have been machine translated. Your task is to post-edit this translation according to the following instructions: {instructions}. " +
